...
export function FinalCTA({
  ...
  return (
    <section className="py-16">
      <div className="bg-primary text-on-primary  p-16 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Button variant="inverse" size="xl" className="!text-white" data-cta="final-cta-primary">
              {primaryLabel}
            </Button>
